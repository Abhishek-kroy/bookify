      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between h-16 items-center">
          ...
          >
            ...
            <Link to="/" className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 hover:from-blue-500 hover:to-purple-600 transition duration-300">
              Bookify
            </Link>
          </motion.div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Link to={item.path} className="text-gray-300 hover:text-blue-400 transition duration-300 relative group">
                  {item.name}
          ...
          <div className="flex items-center space-x-4">
            ...
            {firebase.user && (
              <div className="hidden md:flex items-center space-x-4">
                ...
                >
                  <Link to="/favorites" className="text-gray-300 hover:text-pink-400 transition duration-300 relative">
                    <Heart size={20} />
                ...
                <motion.div
                  whileHover={{ scale: 1.1 }}
                >
                  <Link to={`/cart/${firebase.user.uid}`} className="text-gray-300 hover:text-blue-400 transition duration-300 relative">
        ...
        <div className="px-6 py-4 space-y-3">
          ...
          {firebase.user && (
            <>
              ...
              <Link 
                to="/favorites" 
                className="flex items-center text-gray-300 hover:text-pink-400 transition duration-300 py-2"
                onClick={() => setMobileMenuOpen(false)}
              >
              ...
              <Link 
                to={`/book/order/${firebase.user.uid}`}
                className="flex items-center text-gray-300 hover:text-blue-400 transition duration-300 py-2"
                onClick={() => setMobileMenuOpen(false)}
              >
                <ShoppingCart size={18} className="mr-3" />
